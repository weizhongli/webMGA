...
$prog_overview="<h3> <center>Identify duplicated pair-ended (PE) reads (cd-hit-dup-PE)</center> </h3>
...
<h5>Inputs:</h5>
<OL>
  <LI>R1 reads in FASTA format (required), can be in .gz format
  <LI>R2 reads in FASTA format (required), can be in .gz format
</OL>
