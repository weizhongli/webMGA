...
$prog_overview="<h3> <center>two-step hierarchical protein clustering (h-cd-hit)</center> </h3>
...
<br />
<br />
h-cd-hit creates a non-redudant protein database hierarchically in two steps:  The sequences are first clustered at cutoff=0.9 (90% identity), 
...
$opt="-d 0 -n 5 -p 1 -G 0 -c 0.9 -aS 0.9";
$opt2="-d 0 -n 4 -p 1 -G 0 -c 0.6 -aS 0.6";
$opt_desc="
