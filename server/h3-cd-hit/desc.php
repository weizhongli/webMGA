...
$prog_overview="<h3> <center>three-step hierarchical protein clustering (h-cd-hit)</center> </h3>
...
<br />
<br />
h3-cd-hit creates a non-redudant protein database hierarchically in three steps:  The sequences are first clustered at cutoff=0.9 (90% identity), 
then the resulting non-redundant sequences are clustered at cutoff=0.6 (60% identity), 
and finally the  resulting non-redundant sequences from step 2 are clustered at  cutoff=0.3 (30% identity),
<br />
<br />
The first 2 steps are done with regular cd-hit and the last step is performed by psi-cd-hit
...
$opt2="-d 0 -n 4 -p 1 -G 0 -c 0.6 -aS 0.8";
$opt3="-c 0.3";
$opt_desc="
parameters for set 1 and 2 (they are cd-hit parameters):
...
parameters for set 3 (psi-cd-hit parameters):
